<%@ Page Title="GridView" Language="C#" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeBehind="GridView.aspx.cs" Inherits="ResponsiveWebApplication.GridViewModule" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    <dx:ASPxGridView runat="server" ID="GridView" ClientInstanceName="gridView"
        ...
        <Columns>
            ...
            <dx:GridViewDataComboBoxColumn FieldName="Status" CellStyle-HorizontalAlign="Center" Width="90">
                <DataItemTemplate>
                        <span class="status-column <%# ((int)Eval("Status")) == 1 ? "active" : "closed" %>"></span>
                </DataItemTemplate>
                <PropertiesComboBox>
                    <Items>
            ...
            <dx:GridViewDataColumn FieldName="Votes" Width="80">
                <DataItemTemplate>
                    <%# ((int)Eval("Votes") != 0) ? "<span class='votes-column'>" + Eval("Votes") + "</span>" : "" %>
                </DataItemTemplate>
    ...
    <asp:ObjectDataSource ID="GridViewDataSource" runat="server" DataObjectTypeName=" ResponsiveWebApplication.Model.Issue"
        TypeName=" ResponsiveWebApplication.Model.DataProvider"
        SelectMethod="GetIssues" InsertMethod="AddNewIssue" UpdateMethod="UpdateIssue"></asp:ObjectDataSource>

    <asp:ObjectDataSource ID="ContactsDataSource" runat="server" DataObjectTypeName=" ResponsiveWebApplication.Model.Contact"
        TypeName=" ResponsiveWebApplication.Model.DataProvider"
