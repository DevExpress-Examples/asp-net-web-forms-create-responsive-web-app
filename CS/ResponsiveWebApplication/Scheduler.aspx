...
<%@ Register Assembly="DevExpress.Web.ASPxScheduler.v18.2, Version=18.2.17.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxScheduler" TagPrefix="dx" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <asp:ObjectDataSource ID="AppointmentDataSource" runat="server" DataObjectTypeName=" ResponsiveWebApplication.Model.SchedulerAppointment"
        TypeName=" ResponsiveWebApplication.Model.AppointmentDataSourceHelper"
    ...
    <asp:ObjectDataSource ID="ResourcesDataSource" runat="server" DataObjectTypeName=" ResponsiveWebApplication.Model.SchedulerResource"
        TypeName=" ResponsiveWebApplication.Model.ResourceDataSourceHelper"
